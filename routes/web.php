...
Route::middleware('admin.auth')->group(function () {
    ...
    Route::get('/galeria',        AdminGaleria::class)->name('galeria');
    Route::post('/admin/galeria-upload', [GaleriaUploadController::class, 'upload'])->name('galeria.upload');
